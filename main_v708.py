...
class V708TradingEngine:
    ...
    def check_signals(self):
        ...
        try:
            ...
            # ⚠️ 重要：信号名称描述"系统状态"，交易方向采用"逆向策略"
            # BEARISH_SINGULARITY = 系统看空（张力极正）→ 我们做多（反向抄底）
            # BULLISH_SINGULARITY = 系统看涨（张力极负）→ 我们做空（反向逃顶）
            direction_map = {
                'BEARISH_SINGULARITY': 'long',     # 系统看空 → 我们反向做多 ✅
                'HIGH_OSCILLATION': 'short',       # 高位震荡 → 做空 ✅
                'BULLISH_SINGULARITY': 'short',    # 系统看涨 → 我们反向做空 ✅
